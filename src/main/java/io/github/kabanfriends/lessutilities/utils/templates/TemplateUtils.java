package io.github.kabanfriends.lessutilities.utils.templates;
...
public class TemplateUtils {
    ...
    public static void compressTemplateNBT(ItemStack stack, String name, String author, String template) {
        try {
            byte[] b64 = CompressionUtils.toBase64(CompressionUtils.toGZIP(template.getBytes(StandardCharsets.UTF_8)));
